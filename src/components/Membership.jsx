  ...
  return (
    <div className='container text-center mt-5'>
        <div className='row d-flex justify-content-center mt-4'>
            <div className='col-7 bg-dark text-white text-start rounded-3 px-5 py-5 d-flex align-items-center'>
                <div className='col-8'>
            ...
            <div className='col-2 bg-dark text-white text-start rounded-3 ms-2 py-2'>
